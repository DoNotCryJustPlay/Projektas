...
<body>
            ...
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="index.php" class="myg">Pagrindinis</a></li>
                        <li><a href="menu.php" class="myg">Receptai</a></li>
                        <li><a href="blog.php" class="myg">Atsiųsk savo receptą</a></li>
                        <li><a href="contact.php" class="myg">Kontaktai</a></li>
                        <li><?php if (isset($_SESSION['user'])): ?>
                <!-- Jei vartotojas yra prisijungęs, rodome 'Log out' mygtuką -->
                <a href="prisijungimas/logout.php" class="myg">Atsijungti</a>
                <p>Sveiki, <?php echo $_SESSION['user']; ?>!</p>
            <?php else: ?>
                <!-- Jei vartotojas nėra prisijungęs, rodome 'Log in' mygtuką -->
                <a href="prisijungimas/login.php" class="myg">Prisijungti</a>
            <?php endif; ?></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h4>Čia galite rasti skanių patiekalų</h4>
                    <h2>Skonio kelionė</h2>
                    <p>Receptas – tai ne taisyklė, o kvietimas kurti.</p>
                    <div class="primary-button">
                        <a href="menu.html" data-id="book-table">Receptai</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="cook-content">
                        <h4>Pasidalink savo receptu</h4>
                        <div class="contact-content">
                            <div class="primary-white-button">
                                <a href="#" class="scroll-link" data-id="book-table">Dalintis</a>
                            </div>
                            <h6></h6>
                            <span>arba</span>  
                        </div>
                        ...
                        <div class="primary-white-button">
                            <a href="#" class="scroll-link" data-id="book-table">Naršyk</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <a href="menu.html">
                        <img src="img/gerimai.webp" alt="Desserts">
                        <h4>Gėrimai</h4>
                        </a>
                    </div>
                </div>
    ...
    <section class="get-app">
        <div class="container">
            <div class="row">
                <div class="heading">
                    <h2>Savaitės populiariausi receptai</h2>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="our-blog">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="heading">
                        <h2>Populiariausi patiekalai</h2>
                    </div>
                </div>
            </div>
            <div class="row">
